...
\begin{nopagenumber}
	...
	\begin{center}
		...
		\includepdf[pages=1, scale=1, pagecommand=\heiti\sanhao{外\quad{}文\quad{}原\quad{}文}]{docs/translation.pdf}
		% 原文剩余部分
		\includepdf[pages=2-, scale=1, pagecommand={}]{docs/translation.pdf}
	\end{center}
	...
	\begin{center}
		...
		\xiaosihao\songti{Lisa Ehrlinger and Wolfram Wöß}

		\xiaosihao\songti{约翰·开普勒林茨大学}
	\end{center}
...
% 指导教师指导记录表
\blankmatter
\includepdf[pages=-]{docs/record.pdf}

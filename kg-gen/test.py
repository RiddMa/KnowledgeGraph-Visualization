...
def load_data(g):
    ...
    Apollo13 = Node("Movie", title="Apollo 13", released=1995, tagline="Houston, we have a problem.")
    AsGoodAsItGets = Node(
        "Movie", title="As Good as It Gets", released=1997, tagline="A comedy from the heart that goes for the throat."
    )
    AudreyT = Node("Person", name="Audrey Tautou", born=1976)
    BenM = Node("Person", name="Ben Miles", born=1967)
    BicentennialMan = Node(
        "Movie",
    ...
    CastAway = Node("Movie", title="Cast Away", released=2000, tagline="At the edge of the world, his journey begins.")
    CharlieWilsonsWar = Node(
        "Movie",
    ...
    CloudAtlas = Node("Movie", title="Cloud Atlas", released=2012, tagline="Everything is connected")
    ...
    FrostNixon = Node(
        "Movie", title="Frost/Nixon", released=2008, tagline="400 million people were waiting for the truth."
    )
    ...
    Hoffa = Node("Movie", title="Hoffa", released=1992, tagline="He didn't want law. He wanted justice.")
    ...
    JerryMaguire = Node("Movie", title="Jerry Maguire", released=2000, tagline="The rest of his life begins now.")
    ...
    JoeVersustheVolcano = Node(
        "Movie", title="Joe Versus the Volcano", released=1990, tagline="A story of love, lava and burning desire."
    )
    ...
    NinjaAssassin = Node(
        "Movie", title="Ninja Assassin", released=2009, tagline="Prepare to enter a secret world of assassins"
    )
    ...
    OneFlewOvertheCuckoosNest = Node(
        "Movie",
    ...
    SleeplessInSeattle = Node(
        "Movie",
        title="Sleepless in Seattle",
        released=1993,
        tagline="What if someone you never met, someone you never saw, someone you never knew was the only someone for you?",
    )
    SnowFallingonCedars = Node(
        "Movie", title="Snow Falling on Cedars", released=1999, tagline="First loves last. Forever."
    )
    SomethingsGottaGive = Node("Movie", title="Something's Gotta Give", released=2003)
    SpeedRacer = Node("Movie", title="Speed Racer", released=2008, tagline="Speed has no limits")
    StandByMe = Node(
        "Movie",
        title="Stand By Me",
        released=1986,
    ...
    TheBirdcage = Node("Movie", title="The Birdcage", released=1996, tagline="Come as you are")
    TheDaVinciCode = Node("Movie", title="The Da Vinci Code", released=2006, tagline="Break The Codes")
    TheDevilsAdvocate = Node("Movie", title="The Devil's Advocate", released=1997, tagline="Evil has its winning ways")
    TheGreenMile = Node("Movie", title="The Green Mile", released=1999, tagline="Walk a mile you'll never forget.")
    TheMatrix = Node("Movie", title="The Matrix", released=1999, tagline="Welcome to the Real World")
    TheMatrixReloaded = Node("Movie", title="The Matrix Reloaded", released=2003, tagline="Free your mind")
    TheMatrixRevolutions = Node(
        "Movie", title="The Matrix Revolutions", released=2003, tagline="Everything that has a beginning has an end"
    )
    ThePolarExpress = Node("Movie", title="The Polar Express", released=2004, tagline="This Holiday Season… Believe")
    TheReplacements = Node(
        "Movie", title="The Replacements", released=2000, tagline="Pain heals, Chicks dig scars... Glory lasts forever"
    )
    ...
    TopGun = Node("Movie", title="Top Gun", released=1986, tagline="I feel the need, the need for speed.")
    Twister = Node("Movie", title="Twister", released=1996, tagline="Don't Breathe. Don't Look Back.")
    Unforgiven = Node("Movie", title="Unforgiven", released=1992, tagline="It's a hell of a thing, killing a man")
    ValK = Node("Person", name="Val Kilmer", born=1959)
    VforVendetta = Node("Movie", title="V for Vendetta", released=2006, tagline="Freedom! Forever!")
    ...
    WhatDreamsMayCome = Node(
        "Movie",
        title="What Dreams May Come",
        released=1998,
        tagline="After life there is more. The end is just the beginning.",
    )
    WhenHarryMetSally = Node(
        "Movie", title="When Harry Met Sally", released=1998, tagline="At odds in life... in love on-line."
    )
    WilW = Node("Person", name="Wil Wheaton", born=1972)
    YouveGotMail = Node("Movie", title="You've Got Mail", released=1998, tagline="At odds in life... in love on-line.")
    ...
    JoelSTheMatrixRevolutions = Relationship(JoelS, "PRODUCED", TheMatrixRevolutions)
    ...
    MilosFOneFlewOvertheCuckoosNest = Relationship(MilosF, "DIRECTED", OneFlewOvertheCuckoosNest)
    ...
    ScottHSnowFallingonCedars = Relationship(ScottH, "DIRECTED", SnowFallingonCedars)
    ...
    VincentWWhatDreamsMayCome = Relationship(VincentW, "DIRECTED", WhatDreamsMayCome)
    ...
    JamesCSnowFallingonCedars = Relationship(JamesC, "ACTED_IN", SnowFallingonCedars)
    ...
    LanaWTheMatrixRevolutions = Relationship(LanaW, "DIRECTED", TheMatrixRevolutions)
    ...
    LillyWTheMatrixRevolutions = Relationship(LillyW, "DIRECTED", TheMatrixRevolutions)
    ...
    NancyMSomethingsGottaGive = Relationship(NancyM, "DIRECTED", SomethingsGottaGive)
    NancyMSomethingsGottaGive = Relationship(NancyM, "PRODUCED", SomethingsGottaGive)
    ...
    AnnabellaSWhatDreamsMayCome = Relationship(AnnabellaS, "ACTED_IN", WhatDreamsMayCome)
    ...
    NathanJoeVersustheVolcano = Relationship(Nathan, "ACTED_IN", JoeVersustheVolcano)
    ...
    MegRJoeVersustheVolcano["roles"] = ["DeDe", "Angelica Graynamore", "Patricia Graynamore"]
    ...
    DianeKSomethingsGottaGive = Relationship(DianeK, "ACTED_IN", SomethingsGottaGive)
    ...
    VictorGSleeplessInSeattle = Relationship(VictorG, "ACTED_IN", SleeplessInSeattle)
    ...
    TomHThePolarExpress["roles"] = ["Hero Boy", "Father", "Conductor", "Hobo", "Scrooge", "Santa Claus"]
    ...
    EthanHSnowFallingonCedars = Relationship(EthanH, "ACTED_IN", SnowFallingonCedars)
    ...
    DannyDOneFlewOvertheCuckoosNest = Relationship(DannyD, "ACTED_IN", OneFlewOvertheCuckoosNest)
    DannyDOneFlewOvertheCuckoosNest["roles"] = ["Martini"]
    CharlizeTheDevilsAdvocate = Relationship(Charlize, "ACTED_IN", TheDevilsAdvocate)
    ...
    LaurenceTheMatrixReloaded = Relationship(Laurence, "ACTED_IN", TheMatrixReloaded)
    LaurenceTheMatrixReloaded["roles"] = ["Morpheus"]
    LaurenceTheMatrixRevolutions = Relationship(Laurence, "ACTED_IN", TheMatrixRevolutions)
    ...
    KeanuTheMatrixRevolutions = Relationship(Keanu, "ACTED_IN", TheMatrixRevolutions)
    ...
    JackNOneFlewOvertheCuckoosNest = Relationship(JackN, "ACTED_IN", OneFlewOvertheCuckoosNest)
    ...
    CarrieTheMatrixRevolutions = Relationship(Carrie, "ACTED_IN", TheMatrixRevolutions)
    ...
    JimBCloudAtlas["roles"] = ["Vyvyan Ayrs", "Captain Molyneux", "Timothy Cavendish"]
    BillPullSleeplessInSeattle = Relationship(BillPull, "ACTED_IN", SleeplessInSeattle)
    ...
    TomHCloudAtlas["roles"] = ["Zachry", "Dr. Henry Goose", "Isaac Sachs", "Dermot Hoggins"]
